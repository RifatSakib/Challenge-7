...
const SelectedPlayers = ({ selectItems, handleToogleBtn,handleRemoveCard }) => {
    ...
    return (
        <div className="container mx-auto p-4 mb-96 ">
            ...
            {/* selected Cards */}
                ...
                selectItems.map((selectItem, idx) => <SelectedPlayer key={idx} selectItem={selectItem} handleRemoveCard={handleRemoveCard} ></SelectedPlayer>)
